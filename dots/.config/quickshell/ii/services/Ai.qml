...
Singleton {
    ...
    property var models: Config.options.policies.ai === 2 ? {} : {
        ...
        "gemini-3.5-flash": aiModelComponent.createObject(this, {
            ...
            "icon": "google-gemini-symbolic",
            "description": Translation.tr("Online | Google's model\nMost intelligent Flash model for sustained frontier performance on agentic and coding tasks."),
            ...
            "key_id": "gemini",
            "key_get_link": "https://aistudio.google.com/app/apikey",
            "key_get_description": Translation.tr("**Pricing**: free tier available. Data used for training on the free tier.\n\n**Instructions**: Log into Google account, allow AI Studio to create Google Cloud project or whatever it asks, go back and click Get API key"),
            "api_format": "gemini",
        }),
        "gpt-5.5": aiModelComponent.createObject(this, {
            "name": "GPT-5.5",
            "icon": "openai-symbolic",
            "description": Translation.tr("Online | OpenAI's flagship model\nStrong fit for complex reasoning, coding, and polished assistant responses."),
            "homepage": "https://platform.openai.com/docs/models/gpt-5.5",
            "endpoint": "https://api.openai.com/v1/chat/completions",
            "model": "gpt-5.5",
            "requires_key": true,
            "key_id": "openai",
            "key_get_link": "https://platform.openai.com/api-keys",
            "key_get_description": Translation.tr("**Instructions**: Log into OpenAI Platform, create an API key, then set it here with /key YOUR_API_KEY.\n\n**Note**: This uses OpenAI API billing, not a ChatGPT subscription."),
            "api_format": "openai",
        }),
        "gpt-5.4-mini": aiModelComponent.createObject(this, {
            "name": "GPT-5.4 Mini",
            "icon": "openai-symbolic",
            "description": Translation.tr("Online | OpenAI's faster, lower-cost model\nGood default when you want ChatGPT-style quality with better latency and cost."),
            "homepage": "https://platform.openai.com/docs/models/gpt-5.4-mini",
            "endpoint": "https://api.openai.com/v1/chat/completions",
            "model": "gpt-5.4-mini",
            "requires_key": true,
            "key_id": "openai",
